    ...
    <div className="border-t-2 border-red-600 w-16 mx-auto my-4"></div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mt-12">
                ...
                <h3 className="mb-2 text-xl font-semibold">Marketing Consultancy</h3>
                ...
                <h3 className="mb-2 text-xl font-semibold">Business Consulting</h3>
                ...
                <h3 className="mb-2 text-xl font-semibold">Performance Management</h3>
                ...
                <h3 className="mb-2 text-xl font-semibold">Personnel Mentoring and Training</h3>
                ...
                <h3 className="mb-2 text-xl font-semibold">Brand Management</h3>
                ...
                <h3 className="mb-2 text-xl font-semibold">Web Strategies</h3>
                <p className="text-gray-600 dark:text-gray-400">Web strategies refer to comprehensive plans and approaches that businesses use to leverage the internet and online platforms to achieve their goals.</p>
                </div>
            </div>
            </div>
        </section>
